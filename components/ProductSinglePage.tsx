        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-500 mb-6">
              ...
              high-quality natural sesame seeds, customized to meet your
              business requirements. Indicate whether you need organic or
              conventional seeds, and provide your preferred delivery timeline.
            </p>
            <form className="space-y-12 md:space-y-16">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <p className="text-sm md:text-base text-gray-500">
                    Are you seeking a quote for a long-term annual supply or
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <p className="text-sm md:text-base text-gray-500">
                    You can upload references or specification sheet in image
                    and pdf formats.
                  </p>
