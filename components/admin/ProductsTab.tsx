  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Success",
          description: `Product ${formData.id ? 'updated' : 'created'} successfully.`,
        })
      } else {
      ...
      toast({
        title: "Error",
        description: `Failed to ${formData.id ? 'update' : 'create'} product. Please try again.`,
        variant: "destructive",
      })
    } finally {
                  ...
                  products.map((product: any) => (
                    ...
                    >
                      ...
                      <TableCell>
                        ...
                        >
                          {loadingStates[product.id] ? <Loader2 className="h-4 w-4 animate-spin" /> : <Eye className="h-4 w-4" />}
                        </Button>
                        <Button 
                          variant="ghost" 
                          size="icon" 
