...
export default function AboutUs({ title = "Welcome to Artesana", description ="Unlock endless possibilities with our export company. By focusing on top-tier agro products, we empower businesses like yours to excel in the global market.", action=true }: AboutUsProps) {
  return (
