...
export default function ContactUs() {
  ...
  return (
    <>
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            contactPoint: {
              "@type": "ContactPoint",
              telephone: "+2347081746683",
              contactType: "customer service",
              email: "info@artesana.com.ng",
              areaServed: "NG",
              availableLanguage: ["English"],
            },
            address: {
              "@type": "PostalAddress",
              streetAddress: "Tunde adeniran street",
      ...
      <section
        id="contactUs"
        className="py-16 font-mono bg-gradient-to-br from-primary to-black text-white"
      >
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      className="text-accent text-opacity-90 hover:opacity-100"
                      href="tel:+2347081746683"
                    >
                      +234 708 174 6683
                    </a>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      className="text-accent text-opacity-90 hover:text-opacity-100 transition-colors"
