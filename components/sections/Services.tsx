...
const Services = () => {
  return (
    <section id="services" className="bg-accent-foreground text-white font-mono">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div
              key={service.title}
              className="bg-secondary rounded-lg shadow-md p-6 flex flex-col items-center text-center"
            >
